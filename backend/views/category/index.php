    ...
    function view(id){
        ...
        $.ajax({
            ...
            success: function(res){
                ...
                htmlStr += '<div class="col-lg-3 text-right"><label>分类ID</label></div>';
                htmlStr += '<div class="col-lg-9">'+res.id+'</div>';
                htmlStr += '</div>';
                htmlStr += '<div class="row">';
                htmlStr += '<div class="col-lg-3 text-right"><label>分类名称</label></div>';
                htmlStr += '<div class="col-lg-9">'+res.name+'</div>';
                htmlStr += '</div>';
                htmlStr += '<div class="row">';
                htmlStr += '<div class="col-lg-3 text-right"><label>文章总数</label></div>';
                htmlStr += '<div class="col-lg-9">'+res.count+'</div>';
                htmlStr += '</div>';
                htmlStr += '<div class="row">';
                htmlStr += '<div class="col-lg-3 text-right"><label>创建时间</label></div>';
                htmlStr += '<div class="col-lg-9">'+res.create_time+'</div>';
                htmlStr += '</div>';
                htmlStr += '<div class="row">';
                htmlStr += '<div class="col-lg-3 text-right"><label>更新时间</label></div>';
                htmlStr += '<div class="col-lg-9">'+res.update_time+'</div>';
                htmlStr += '</div>';
                htmlStr += '<div class="row">';
                htmlStr += '<div class="col-lg-3 text-right"><label>图片</label></div>';
