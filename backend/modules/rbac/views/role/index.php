        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <div class="box-header with-border">
                    <h2 class="box-title"><i class="fa fa-users"></i>  <?= $this->title ?></h2>
                </div>
                <!-- /.box-header -->
                ...
                <div class="box-body">
                    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                        ...
                        <div class="row pull-right">
                            <div class="col-xs-12">
                                <div class="btn-list">
                                    <a class="btn btn-sm btn-primary" href="<?= Url::to(['role/create']) ?>" role="button"><i class="fa fa-plus"></i> 添加角色</a>
                                </div>
                            </div>
                        </div>
                        <!-- row end btn -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="<?=Url::to(['role/update','name' => $item['name']]); ?>" data-widget="编辑" data-toggle="tooltip" title="编辑"><span class="fa fa-edit"></span></a>&nbsp;
...
<script type="text/javascript">
    ...
    function delcfm(id) {
        $('#role-id').val(id);//给会话中的隐藏属性URL赋值
        $('#delete-role').modal();
    }

    function execDelete(){
        var name = $.trim($("#role-id").val());//获取会话中的隐藏属性URL
